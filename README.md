...
- **\<window name\> window scale:** Scales the corresponding UI window to given factors in width (X) and height (Y). Reopen ComponentUtil window for the change to apply. (Default: 1, 1)
